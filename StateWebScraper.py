...
normal_districts = pd.read_csv("CSV_Files/state_results.csv")

# CSV file for writing and viewing the results of CafrScraper.py
county_report = pd.read_csv("CSV_Files/state_information.csv")
...
website_csv = "CSV_Files/state_results.csv"
...
for index, row in website_dataset.iterrows():
    ...
    county_report.to_csv("CSV_Files/state_information.csv", encoding='utf-8', index=None)
    time.sleep(1)
